...
* ```
*/
export function httpAuth(type:string, credential:string):Record<string, string>{
    return {
...
* ```
*/
export function httpContent(body:BodyInit, mime?:string):Record<string, string>{
    let v = "";

    if(mime && typeof body !== "string"){
        switch(mime){
            case "zip": v = "application/zip"; break;
            case "png": v = "image/png"; break;
            default: v = mime; break;
        }
    }
    else if([Blob, ArrayBuffer, Uint8Array, ReadableStream].some(t => body instanceof t)){
        ...
        switch(mime){
            case "json": v = "application/json"; break;
            case "xml": v = "application/xml"; break;
            case "yaml": v = "application/yaml"; break;
            case "csv": v = "text/csv"; break;
            case "html": v = "text/html"; break;
            default: v = "text/plain"; break;
        }
    }
